    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text>
          ...
          Board of Review Rule #18, respectfully petitions this Honorable Board
          to reduce the Assessed Valuation (AV) of the subject property. In
          support thereof, the Taxpayer states as follows:
        </Text>
      </View>
      <View style={styles.section}>
        ...
        <Text style={{ marginTop: 5 }}>
          ...
          consideration of properties is {editAppealData.purchase_price}
        </Text>
        <Text style={{ marginTop: 10 }}>
          2. The buyer(s), {editAppealData.sale_buyer_name}, and the seller(s),
          Juan Valerio Corpus, were not related and had no prior personal or
          professional relationship. The transaction was conducted at arm’s
          length.
        </Text>
        <Text style={{ marginTop: 10 }}>
          3. The property was publicly marketed and listed through the Multiple
          Listing Service (MLS) under MLS number MRED #
        ...
        <Text style={{ marginTop: 10 }}>
          4. Based on this recent sale, the correct Assessed Valuation should be
          adjusted accordingly to reflect the market value established by the
          purchase price.
        </Text>
      </View>
      <View style={styles.section}>
        ...
        <Text style={{ marginTop: 5 }}>Land AV: ${editAppealData.land_av}</Text>
        <Text>
