...
const DocumentsStatusAppealModel = () => {
  ...
  return (
    <Dialog
      ...
      defaultOpen={documentsStatusAppealModel ?? false}
    ...
    >
      ...
      <p id="dialog-description" className="sr-only">
        This dialog shows the status of signature documents for appeal.
      </p>
      <DialogContent
        description="--"
            ...
            <div className="py-8 flex flex-col gap-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <p className=" text-[#80838E] px-2 py-1 rounded-[8px]">
                  {formatDate(data.doc_created_at, "MM/dd/yyyy")}
                </p>
              </div>
              <div className="flex justify-between items-center">
