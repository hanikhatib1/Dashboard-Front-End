      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={{ marginTop: 5 }}>
            Owner Name: {editAppealData.client_name}
          </Text>
          <Text style={{ marginTop: 5 }}>
        ...
        <View style={styles.section}>
          ...
          <Text style={{ marginTop: 5, marginBottom: 5 }}>
            Exhibit A: Recent photo of the subject property.
          </Text>
          <Text style={{ marginTop: 5, marginBottom: 5 }}>
            Exhibit B: Map of selected comparable properties showing their
            proximity to the subject property.{" "}
          </Text>
          <Text style={{ marginTop: 5, marginBottom: 5 }}>
            Exhibit C: Photos of the selected comparable properties.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={{ fontWeight: "bold", color: "#405E8D" }}>
          ...
          <Text style={{ marginTop: 5, marginBottom: 5 }}>
            Exhibit D: “Lack of Uniformity / Comparable Properties Matrix
            Report” presenting the subject property alongside the selected
            comparables, including their assessed valuations and supporting
          ...
          <Text style={{ marginTop: 5 }}>
            n light of the above, we respectfully request that the market value
        ...
        <View style={styles.section}>
          <Text style={{ marginTop: 5, marginBottom: 15 }}>Exhibits</Text>
          <Text style={{ marginTop: 5 }}>Hani H. Khatib</Text>
          <Text style={{ marginTop: 5 }}>Attorney for Taxpayer</Text>
          <Text style={{ marginTop: 5 }}>
            Board of Review Number:{stateNumber.boardOfReviewNumber}{" "}
          </Text>
        </View>
        <View style={styles.section}>
          <Text
          ...
          <Text>
            Exhibit A: Recent Photo of the Subject Property  Exhibit B: Map of
          </Text>
          <Text>
            Comparable Properties  Exhibit C: Photos of Comparable Properties 
          </Text>
          <Text>
            Exhibit D: Lack of Uniformity / Comparable Properties Matrix Report 
          </Text>
          <Image
